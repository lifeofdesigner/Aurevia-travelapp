...
import {AdminLiveChatDepartmentsManager} from "@/features/live-chat/components/admin-live-chat-management";
...
export default async function AdminLiveChatDepartmentsPage({
  params
}: {
  ...
  return (
    <main className="space-y-6">
      <AdminPageHeader
        ...
        description="Organize incoming chats by team, queue, and routing area."
        eyebrow="Customer care"
        title="Live chat departments"
      />
      <AdminLiveChatDepartmentsManager departments={data.departments} />
    </main>
  );
}
